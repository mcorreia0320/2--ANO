...
import pt.tpsi.ad.pi4j.SimpleEventHandler;
import pt.tpsi.ad.pi4j.MeasurementException;
...
public class UltrasonicDistanceSensorComponent extends Component {
    ...
    private final class Poller implements Runnable {
        ...
        private void triggerSimpleEvent(SimpleEventHandler simpleEventHandler) {
        }
    }
}
